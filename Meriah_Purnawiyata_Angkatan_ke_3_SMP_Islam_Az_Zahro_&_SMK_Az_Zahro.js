const artikelData = {
  ...
  <p>Mengusung tema utama <em>"Melangkah dengan Ilmu, Mengabdi dengan Iman, Meraih Prestasi Gemilang"</em>, acara ini dirancang dengan sangat apik, memadukan nilai-nilai akademis, kultural pesantren, dan formalitas kedinasan yang profesional.</p>
  <hr>
  <div style='text-align: center; margin: 20px 0;'>
    <img src='https://i.ibb.co.com/xtgtRBY3/gambar1pesertapurnawiyata.jpg' alt='Peserta Purnawiyata' style='max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);'/>
    <p style='font-style: italic; color: #555; margin-top: 5px;'>Gambar 1: Peserta Purnawiyata Kelas IX SMP Islam Az-Zahro dan SMK Az-Zahro bersiap mengikuti jalannya prosesi utama.</p>
  </div>`
};
